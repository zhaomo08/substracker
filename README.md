...
> 🎉 项目说明：
> - 当前项目为独立维护版本，后续改动以本仓库为准
> - 项目在功能和实现上参考了 [wangwangit/SubsTracker](https://github.com/wangwangit/SubsTracker)
> - 欢迎大家直接试用并提出 Issue / PR
...
```bash
git clone https://github.com/zhaomo08/substracker.git
cd substracker
```
